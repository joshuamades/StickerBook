...
export class Game extends Phaser.Scene {
  ...
  create() {
    ...
    document.addEventListener("touchstart", this.unlockAudioHandler, { once: true });
    document.addEventListener("mousedown", this.unlockAudioHandler, { once: true });
    ...
    this.events.once(Phaser.Scenes.Events.SHUTDOWN, () => {
      ...
      if (this.unlockAudioHandler) {
        document.removeEventListener("touchstart", this.unlockAudioHandler);
        document.removeEventListener("mousedown", this.unlockAudioHandler);
      }
    });
